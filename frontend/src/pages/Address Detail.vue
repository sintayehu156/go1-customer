      ...
      <div class="main-content">
        <div class="bg-white shadow-md rounded-lg p-6 space-y-6 pb-[2.625rem] ml-[126px] mr-[120px]">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <FormControl type="text" size="md" variant="subtle" label="Address Title" :disabled="!isEditing"
                v-model="address_title" class="mb-5" />
              <FormControl type="select" size="md" :options="statusOptions" :disabled="!isEditing" variant="subtle"
                label="Address Type" v-model="address_type" class="mb-5" />
              <FormControl type="text" size="md" variant="subtle" label="Address Line 1" :disabled="!isEditing"
                v-model="address_line1" class="mb-5" />
              <FormControl type="text" size="md" variant="subtle" label="Address Line 2" :disabled="!isEditing"
                v-model="address_line2" class="mb-5" />
              <FormControl type="text" size="md" variant="subtle" label="City" :disabled="!isEditing" v-model="city"
                class="mb-5" />
              <FormControl type="text" size="md" variant="subtle" label="State" :disabled="!isEditing" v-model="state"
                class="mb-5" />
            </div>
            ...
            <div>
              ...
              <FormControl type="number" size="md" variant="subtle" :disabled="!isEditing" label="Postal Code"
              ...
              <FormControl type="number" size="md" variant="subtle" :disabled="!isEditing" label="Phone" v-model="phone"
                class="mb-5" />
              <FormControl type="text" size="md" :disabled="!isEditing" variant="subtle" label="GSTIN" v-model="gstin"
                class="mb-5" />
            </div>
          </div>
